...
Options:
  ...
  -o, --out_file PATH   Output file path  [default:
                        2026-07-31_21_39_35.anonymized.txt]
  -n, --name_list PATH  The path to the file containing the list of names to
                        be anonymized
  -i, --id_list PATH    The path to the file containing the list of IDs to be
                        anonymized
